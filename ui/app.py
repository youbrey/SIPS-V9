...
from config import (
    APP_TITLE, APP_GEOMETRY, APP_MIN_SIZE, APPEARANCE_MODE, COLOR_THEME,
    DATABASE_XLSX, COLOR_CONTENT_BG,
)
...
class SIPSApp(
    ...
    def __init__(self):
        ...
        self.configure(fg_color=COLOR_CONTENT_BG)
        ...
        self.middle_outer_frame = ctk.CTkScrollableFrame(
            self, label_text="Form Data Surat",
            fg_color="#FFFFFF", border_width=1, border_color="#E6ECF5",
        )
    ...
    def _on_root_configure(self, event):
        # Hanya proses event resize dari jendela utama itu sendiri,
        # bukan dari widget anak yang juga memicu <Configure>.
